...
<%
    ...
    String select = "SELECT c.itemimage, c.itemtitle, c.usernickname, c.address, c.useage, c.itemcode \n";
    String from = "FROM user AS b INNER JOIN item AS c ON b.email = c.user_email \n";
    String where = "WHERE b.email = ? AND c.dealcompletedate IS NOT NULL";
    int count = 0;
