...
String select = "SELECT c.itemimage, c.itemtitle, c.usernickname, c.address, c.useage, c.usernickname \n";
...
String where = "WHERE ((a.buyer = ? AND a.buyerscore != '0') OR (a.seller = ? AND a.sellerscore != '0')) AND c.dealcompletedate IS NOT NULL \n";
